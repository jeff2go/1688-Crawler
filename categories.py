...
class Categories():
    ...
    def __extract_categories(self, tree):
        link_elements = tree.xpath('//div[contains(@class, "grid-sub")]//div[@class="m-content"]//a[contains(@href, "page/offerlist_")]')
    ...
    def go(self, url):
        ...
        data = {}
        data['data'] = self.__extract_categories(tree)
        data['shop'] = self.__extract_shop_info(tree)

        return data

# categories = Categories()
# TEST_URL = 'https://shop1357318732661.1688.com/page/offerlist.htm?spm=a2615.2177701.0.0.3916fb2aYydGj4'
# print(categories.go(TEST_URL))
